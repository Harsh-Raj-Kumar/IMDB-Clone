...
function getMoviesDropDown(searchText) {
  axios
    .get("https://www.omdbapi.com/?apikey=d8759b02&s=" + searchText)
    .then((response) => {
...
function getMoviesById(id) {
  axios
    .get("https://www.omdbapi.com/?apikey=d8759b02&i=" + id)
    .then((response) => {
...
function getMovie() {
  ...
  axios
    .get("https://www.omdbapi.com/?apikey=d8759b02&i=" + movieId)
    .then((response) => {
      console.log(response);
      let movie = response.data;
